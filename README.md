...
I recommend not stuffing everything into the boilerplate TinTinEditor/PluginProcessor files. Sure, go ahead make a mess at first. But then clean them up and just include your source from there.
